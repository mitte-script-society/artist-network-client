        ...
        <div className="relative flex h-16 items-center justify-between">
          ...
          <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
            ...
            <div className="hidden sm:ml-6 sm:block">
              <div className="flex space-x-4">
                ...
                {!isLoggedIn && 
                <>
                  <a onClick={ () => {setIsLogInWindow(true)}} className="text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">Log In</a>
          ...
          --> */}
              <div id="xxxx" className="hidden absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button" tabindex="-1">
                ...
                <Link to="/edit-user" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-200" role="menuitem" tabindex="-1" id="user-menu-item-0" onClick={() => {document.getElementById("xxxx").classList.toggle("hidden") } }>Edit Profile</Link>
          ...
          <div style={{backgroundColor:"white"}} >
            Should we add something when user is not loged ? 
          </div>
          }
